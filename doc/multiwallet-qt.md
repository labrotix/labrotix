...
In order to support loading of multiple wallets in labrotix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is labrotix.cpp.
...
Changes to labrotix.cpp
----------------------
labrotix.cpp is the entry point into labrotix-qt, and as such, will require some minor modifications to provide hooks for
