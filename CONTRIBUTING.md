Contributing to labrotix Core
============================

The labrotix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the labrotix Core project, and is not to be
confused with overall labrotix Network Protocol consensus changes.

Whether a pull request is merged into labrotix Core rests with the project merge
...
Patches that change labrotix consensus rules are considerably more involved than
...
Where a patch set proposes to change the labrotix consensus, it must have been
...
The project leader is the release manager for each labrotix Core release.
