...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop labrotix server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "labrotix server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* labrotix features */
        {"labrotix", "masternode", &masternode, true, true, false},
        {"labrotix", "listmasternodes", &listmasternodes, true, true, false},
        {"labrotix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"labrotix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"labrotix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"labrotix", "masternodedebug", &masternodedebug, true, true, false},
        {"labrotix", "startmasternode", &startmasternode, true, true, false},
        {"labrotix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"labrotix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"labrotix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"labrotix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"labrotix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"labrotix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"labrotix", "mnbudget", &mnbudget, true, true, false},
        {"labrotix", "preparebudget", &preparebudget, true, true, false},
        {"labrotix", "submitbudget", &submitbudget, true, true, false},
        {"labrotix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"labrotix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"labrotix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"labrotix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"labrotix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"labrotix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"labrotix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"labrotix", "checkbudgets", &checkbudgets, true, true, false},
        {"labrotix", "mnsync", &mnsync, true, true, false},
        {"labrotix", "spork", &spork, true, true, false},
        {"labrotix", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"labrotix", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use labrotixd, or the -server option to labrotix-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> labrotix-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:62001/\n";
}
