...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("labrotix Core labrotix-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  labrotix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded labrotix transaction") + "\n" +
                               "  labrotix-tx [options] -create [commands]   " + _("Create hex-encoded labrotix transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded labrotix transaction
