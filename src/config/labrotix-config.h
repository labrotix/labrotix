/* src/config/labrotix-config.h.  Generated from labrotix-config.h.in by configure.  */
/* src/config/labrotix-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.labrotix.com"
