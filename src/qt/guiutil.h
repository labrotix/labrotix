...
/** Utility functions used by the labrotix Qt UI.
 */
namespace GUIUtil
{
...
// Render labrotix addresses in molabrotixpace font
...
// Parse "labrotix:" URI into recipient object, return true on successful parsing
