                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("labrotix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a labrotix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and labrotix: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLBO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About labrotix Core"), this);
    aboutAction->setStatusTip(tr("Show information about labrotix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for labrotix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your labrotix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified labrotix addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diaglabrotixtic information"));
    ...
    openAction->setStatusTip(tr("Open a labrotix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the labrotix Core help message to get a list with possible labrotix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("labrotix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to labrotix network", "", count));
}
...
{
    QString strTitle = tr("labrotix Core"); // default title
...
/** Creates context menu, its actions, and labrotixs up all the relevant signals for mouse events. */
