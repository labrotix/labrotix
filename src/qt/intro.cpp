...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("labrotix Core"),
     ...
     * override -datadir in the labrotix.conf file in the default data directory
     * (to be consistent with labrotixd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
