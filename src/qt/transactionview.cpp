                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received labrotix from zlabrotix"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zlabrotix"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zlabrotix));
