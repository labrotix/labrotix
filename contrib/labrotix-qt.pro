...
RESOURCES += src/qt/labrotix.qrc src/qt/labrotix_locale.qrc

TRANSLATIONS += src/qt/locale/labrotix_bg.ts \
                src/qt/locale/labrotix_de.ts \
                src/qt/locale/labrotix_en.ts \
                src/qt/locale/labrotix_es.ts \
                src/qt/locale/labrotix_fi.ts \
                src/qt/locale/labrotix_fr.ts \
                src/qt/locale/labrotix_it.ts \
                src/qt/locale/labrotix_ja.ts \
                src/qt/locale/labrotix_pl.ts \
                src/qt/locale/labrotix_pt.ts \
                src/qt/locale/labrotix_ru.ts \
                src/qt/locale/labrotix_sk.ts \
                src/qt/locale/labrotix_sv.ts \
                src/qt/locale/labrotix_vi.ts \
                src/qt/locale/labrotix_zh_CN.ts \
                src/qt/locale/labrotix_zh_TW.ts
